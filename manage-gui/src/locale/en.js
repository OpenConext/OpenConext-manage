const en = {
    ...
    metadata: {
        ...
        sfo: "StepUp SFO",
        sfo_single: "StepUp SFO",
        institution: "StepUp Institution",
        institution_single: "StepUp Institution",
        ...
        deleteConfirmation: "You are going to DELETE the {{name}}.\n\nPlease enter the entityid {{originalEntityId}} of this entity if you are sure:",
    ...
    stepup: {
        ...
        authnContextTitle: "Supported AuthnContext",
        authnContextDescription: "Select the AuthnContext Class References (ACR) that this Identity Provider supports",
        authnContextPlaceholder: "Select the supported AuthnContext class references",
        authnContextTooltip: "The Identity Provider does not necessarily support all possible values<br/>for the RequestedAuthnContext. Select here the ACR values this<br/>Identity Provider is known to support, so Engineblock can take this<br/>into account when sending a RequestedAuthnContext to this IdP.",
    ...
    policies: {
        ...
        institutionProvidersTooltipStepUp: "The IdP's for which this stepup policy is applied. Zero or more are allowed.",
        institutionProvidersPlaceholderStepUp: 'Select the Identity Providers - zero or more',
    ...
    sfo: {
        ...
        acs: "ACS",
        loa: "LOA",
        loaHint: "loa1 is the minimal LoA",
        ...
        secondFactorOnlyNameidPatternsExample: "For example \"urn:collab:person:example.org:*\"",
    ...
    institution: {
        ...
        ssoRegistrationBypass: "SSO Registration bypass",
