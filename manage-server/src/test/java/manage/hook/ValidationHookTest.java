...
public class ValidationHookTest implements TestUtils {

    private ValidationHook subject = new ValidationHook(new MetaDataAutoConfiguration(
            objectMapper,
            new ClassPathResource("metadata_configuration"),
            new ClassPathResource("metadata_templates")));

    public ValidationHookTest() throws IOException {
    }
