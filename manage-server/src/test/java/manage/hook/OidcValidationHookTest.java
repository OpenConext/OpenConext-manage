...
public class OidcValidationHookTest implements TestUtils {
    ...
    @Test
    public void allowSecretPublicRP() throws IOException {
        ...
        hook.prePut(null, metaData(Map.of("secret", "verySecret", "isPublicClient", true)), apiUser());

        hook.prePut(null, metaData(Map.of("secret", "", "isPublicClient", false)), apiUser());

        hook.prePut(null, metaData(Map.of("grants", List.of("urn:ietf:params:oauth:grant-type:device_code"),
            "secret", "verySecret")), apiUser());
